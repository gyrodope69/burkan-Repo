...
#                         }))
#                     else:
#                         print("Websocket closed, skipping sending transcript")
#                 except RuntimeError:
#                     pass
...
#                     print("Calling Gemini.... (true final)")
...
#                 # If >2s since last transcript and one exists and hasn't been sent as final
#                 if last_transcript and (now - last_message_time > 2.0) and not transcript_sent_as_final:
#                     print("Forcing Gemini call after idle (time-based forced final)")
...
#             finally:
#                 # Do NOT put None here during call
#                 pass
